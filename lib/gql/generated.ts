...
export type GetUsersQuery = { __typename?: 'Query', users?: Array<{ __typename?: 'User', id: string, name: string, dob: string, address: string, description: string } | null> | null };
...
export type SearchUsersQuery = { __typename?: 'Query', users?: Array<{ __typename?: 'User', id: string, name: string, dob: string, address: string, description: string } | null> | null };
